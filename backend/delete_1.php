...
<body>
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($response > 0) {
    ?>
            <h2 class="titulo__crud">Registro encontrado</h2>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) { ?>
                        <form action="delete-good.php" method="post">
                            <tr>
                                <td scope="row">
                                    <input type="hidden" name="clave" value="<?php echo $row['clave']; ?>">
                                    <input type="text" name="id" id="clave" class="input-text__input" value="<?php echo $row['clave']; ?>" disabled>
                                </td>
                                <td>
                                    <input type="hidden" name="nombre" value="<?php echo $row['nombres']; ?>">
                                    <input type="text" id="nombre" class="input-text__input" value="<?php echo $row['nombres']; ?>" disabled>
                                </td>
                                <td>
                                    <input type="hidden" name="apellido" value="<?php echo $row['apellidos'];    ?>">
                                    <input type="text" id="apellido" class="input-text__input" value="<?php echo $row['apellidos']; ?>" disabled>
                                </td>
                                <td>
                                    <input type="hidden" name="edad" value="<?php echo $row['edad'];    ?>">
                                    <input type="text" id="edad" class="input-text__input" value="<?php echo $row['edad'];?>" disabled>
                                </td>
                                <td>
                                    <input type="hidden" name="carrera" value="<?php echo $row['especialidad'];    ?>">
                                    <input type="text"  id="carrera" class="input-text__input" value="<?php echo $row['especialidad'];?>" disabled> 
                                </td>
                                <td>
                                    <input type="hidden" name="genero" value=" <?php echo $row['genero'];    ?>">
                                    <input type="text"  id="genero" class="input-text__input" value="<?php echo $row['genero'];?>" disabled>
                                </td>
                                <td>
                                    <input type="hidden" name="hobby" value="<?php echo $row['hobby'];?>">
                                    <input type="text"  id="hobby" class="input-text__input" value="<?php echo $row['hobby'];?>" disabled>
                                </td>

                            </tr>
                        <?php }
                    mysqli_free_result($resultado)   ?>
                        <button type="submit" class="button button--absolute button--danger" name="eliminar">
                            Eliminar
