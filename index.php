    ...
    <header class="header">
        ...
        <div class="menu">
            <a href="#" class="menu-logo">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="32" fill="currentColor" class="bi bi-1-circle" viewBox="0 0 16 16">
                    <path d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8Zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0ZM9.283 4.002V12H7.971V5.338h-.065L6.072 6.656V5.385l1.899-1.383h1.312Z" />
                </svg>
                <span class="menu-logo__texto">Menú</span>
            </a>
            <hr>
            <ul class="menu-list">
                <li class="menu-list__item">
                    <a href="form.php" class="menu-list__link  menu-list__link-red">
                ...
                <li class="menu-list__item">
                    <a href="search.php" class="menu-list__link">
                ...
                <li class="menu-list__item">
                    <a href="update.php" class="menu-list__link">
                ...
                <li class="menu-list__item">
                    <a href="delete.php" class="menu-list__link">
